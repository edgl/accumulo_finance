...
public class NasdaqYahooGetDailyStockQuotesDriver extends Configured implements Tool {

	public static final Opts opts = new Opts();
	public static Connector accumuloConnector;
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new Configuration(), new NasdaqYahooGetDailyStockQuotesDriver(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(NasdaqYahooGetDailStockQuotesMapper.class);
